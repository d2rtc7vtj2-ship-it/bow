...
(function () {
  ...
  const TOPBAR_SUPABASE_URL = 'https://tvdamzzzeekuvcxngmaj.supabase.co';
  const TOPBAR_SUPABASE_KEY = 'sb_publishable_I0HdgN-xHmZNvD-LxXGoMw_xMTL9Vgc';
...
.topbar {
  ...
  padding: max(10px, env(safe-area-inset-top, 10px)) calc(14px + env(safe-area-inset-right, 0px)) 10px calc(14px + env(safe-area-inset-left, 0px));
